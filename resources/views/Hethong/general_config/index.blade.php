                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="dxtaikhoan">
                                    <option value="0" {{$model->dxtaikhoan == 0?'selected':''}}>Không cho đăng nhập ở thiết bị khác khi tài khoản đang đăng nhập</option>
                                    <option value="1" {{$model->dxtaikhoan == 1?'selected':''}}>Đăng xuất tài khoản ngay lập tức</option>
                                </select>
                            </div>
                        </div>
