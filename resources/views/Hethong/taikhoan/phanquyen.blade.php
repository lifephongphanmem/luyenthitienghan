...
<form action="{{'/TaiKhoan/PhanQuyen'}}" method="POST" id='frm_modify' enctype="multipart/form-data">
    @csrf
<input type="hidden" name="tendangnhap" value="{{ $m_taikhoan->cccd }}" />
                ...
                <div class="form-horizontal">
                    <div class="row form-group">
                        <div class="col-6">
                            ...
                            <input type="text" name='tenchucnang' class="form-control" required>
                        </div>
                    </div>
