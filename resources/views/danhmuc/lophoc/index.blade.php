            ...
            <div class="card card-custom">
                <div class="card-header card-header-tabs-line">
                    <div class="card-title">
                        <h3 class="card-label text-uppercase">DANH MỤC LỚP HỌC</h3>
                    </div>
                        ...
                        <table id="sample_3" class="table table-striped table-bordered table-hover dataTable no-footer">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    <td>{{++$k }} </td>
                                    <td>{{ $item->malop }} </td>
                                    <td class="text-left">{{ $item->tenlop }}</td>
                                    <td>
                                        @if (chkPhanQuyen('dmlophoc', 'thaydoi'))
                                        ...
                                        <button title="Xóa thông tin" data-toggle="modal"
                                            ...
                                            onclick="cfDel('{{ '/dmLopHoc/delete/' . $item->id }}')"
                                            class="btn btn-sm btn-clean btn-icon">
    ...
    <div class="modal fade" id="create_edit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{'/dmLopHoc/store_update'}}" method="post" id="frm_create_edit">
                @csrf
        ...
        function edit(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    form.find("[name='tenlop']").val(data.tenlop);
                },
