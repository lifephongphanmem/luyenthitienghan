                        ...
                        <table id="sample_3" class="table table-striped table-bordered table-hover dataTable no-footer">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    <td>{{++$k }} </td>
                                    <td>{{ $item->manganh }} </td>
                                    <td class="text-left">{{ $item->tennganh }}</td>
                                    <td>
                                        @if (chkPhanQuyen('nganhhoc', 'thaydoi'))
                                        ...
                                        <button title="Xóa thông tin" data-toggle="modal"
                                            ...
                                            onclick="cfDel('{{ '/NganhHoc/delete/' . $item->id }}')"
                                            class="btn btn-sm btn-clean btn-icon">
    ...
    <div class="modal fade" id="create_edit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{'/NganhHoc/store_update'}}" method="post" id="frm_create_edit">
                @csrf
        ...
        function edit(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    form.find("[name='tennganh']").val(data.tennganh);
                },
