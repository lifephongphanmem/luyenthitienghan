                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        ...
                                        <button title="Xóa thông tin" data-toggle="modal" data-target="#delete-modal-confirm" type="button" 
                                         onclick="cfDel('{{'/TrinhDoGDPT/delete/'.$item->id}}')"  class="btn btn-sm btn-clean btn-icon">
...
<div class="modal fade" id="create_edit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class="modal-dialog" role="document">
       <div class="modal-content">
           ...
           <form action="{{'/TrinhDoGDPT/store_update'}}" method="post" id="frm_create_edit">
            @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12">
                        <div class="form-group fv-plugins-icon-container">
                            ...
                            <input type="text" id="tengdpt" name="tendm" class="form-control" />
                        </div>
                    </div>
                </div>
            </div>
