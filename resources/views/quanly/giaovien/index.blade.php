...
@section('content')
            ...
            <div class="card card-custom">
                <div class="card-header card-header-tabs-line">
                    <div class="card-title">
                        <h3 class="card-label text-uppercase">Danh sách giáo viên</h3>
                    </div>
    ...
    <div id="themmoi" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade kt_select2_modal">
        <form action="{{ '/GiaoVien/store' }}" method="POST" id="frm_giaovien" enctype="multipart/form-data">
            @csrf
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header modal-header-primary">
                        <h4 id="modal-header-primary-label" class="modal-title">Thông tin giáo viên
                        </h4>
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="tengiaovien" class="form-control" required>
                            </div>
                            <div class="col-md-6">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            <div class="col-md-6">
                                <label class="control-label">Tên giáo viên<span class="require">*</span></label>
