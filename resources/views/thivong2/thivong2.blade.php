                                ...
                                <ul class="menu-nav">
                                    <li class="menu-item menu-item-active " aria-haspopup="true">
                                        <a href="/epstopik-test/phongvan?phanloai=VANDAP" class="menu-link">
                                            ...
                                            <span class="menu-text">Vấn đáp</span>
                                        </a>
                                    </li>
                                    <li class="menu-item " aria-haspopup="true">
                                        <a href="/epstopik-test/phongvan?phanloai=HIEULENH" class="menu-link">
                                            ...
                                            <span class="menu-text">Hiệu lệnh</span>
                                        </a>
                                    </li>
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="/epstopik-test/gioithieubanthan" class="menu-link">
                                            <span class="svg-icon menu-icon">
                                                <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                            ...
                                            <span class="menu-text">Giới thiệu bản thân</span>
                                        </a>
                                    </li>
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="/epstopik-test/test_mu_mau" class="menu-link">
                                            <span class="svg-icon menu-icon">
                                                <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                            ...
                                            <span class="menu-text">Test mù màu</span>
                                        </a>
                                    </li>
                                    @foreach (congcu() as $k=>$ct)
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="/epstopik-test/CongCu/{{$k}}" class="menu-link">
                                            <span class="svg-icon menu-icon">
                                                <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                    ...
                                    {{-- <li class="menu-item" aria-haspopup="true">
                                        <a href="/epstopik-test/gioithieubanthan" class="menu-link">
                                            ...
                                            <span class="menu-text">Công cụ SXCT</span>
                                        </a>
                                    </li>
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="/epstopik-test/CongCu/2" class="menu-link">
                                            <span class="svg-icon menu-icon">
                                                <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                            ...
                                            <span class="menu-text">Công cụ xây dựng</span>
                                        </a>
                                    </li>
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="" class="menu-link">
                                            ...
                                            <span class="menu-text">Công cụ đóng tàu</span>
                                        </a>
                                    </li>
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="/epstopik-test/gioithieubanthan" class="menu-link">
                                            ...
                                            <span class="menu-text">Công cụ nông nghiệp</span>
                                        </a>
                                    </li>
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="/epstopik-test/gioithieubanthan" class="menu-link">
                                            ...
                                            <span class="menu-text">Công cụ ngư nghiệp</span>
                                        </a>
                                    </li> --}}
                                </ul>
                                <!--end::Menu Nav-->
                    ...
                    <div class="d-flex flex-column-fluid">
                        ...
                        <div class="container">
                            ...
                            {{-- <div class="card card-custom card-stretch gutter-b">
                                <div class="card-body"> --}}
                                    <div class="card card-custom gutter-b congcu">
                                        {{-- <div class="row"> --}}
