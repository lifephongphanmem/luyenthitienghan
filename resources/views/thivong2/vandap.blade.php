...
@section('content_thivong2')
    ...
    <div class="d-flex">
        <button class="btn btn-success mr-2 mt-2" style="width:49.5%" onclick="HienChu()">Hiện chữ</button>
        <button class="btn btn-success ml-2 mt-2" style="width:49.5%" onclick="location.reload()">Khởi động lại</button>
    </div>
    <div class="d-flex">
        <button class="btn btn-primary mr-2 mt-2 stop" style="width:49.5%" onclick="PlayQuest_Order()">Tự động theo thứ tự</button>
        <button class="btn btn-primary ml-2 mt-2 stop" type='button' style="width:49.5%" onclick="PlayQuest_Random()" id="randomButton">Tự động ngẫu nhiên</button>
    </div>
    <div class="d-flex">
        <button class="btn btn-primary mr-2 mt-2" style="width:49.5%" onclick="Handle_Question()">Thủ công theo thứ tự
        </button>
        <button class="btn btn-primary ml-2 mt-2" style="width:49.5%" onclick="Handle_Question_Random()">Thủ công ngẫu nhiên
        </button>
    </div>
    <div class="d-flex">
        <button class="btn btn-primary mr-2 mt-2" style="width:49.5%" onclick="stop()" id='stop'>Dừng</button>
        <button class="btn btn-primary ml-2 mt-2" style="width:49.5%" onclick="NgheLai()">Nghe lại</button>
    </div>
